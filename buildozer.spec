...
requirements = python3, kivy==2.3.0, kivymd, plyer, pillow, google-generativeai, requests, certifi, urllib3, idna, charset-normalizer, matplotlib, numpy, python-dotenv, pg8000, scramp, openssl, asn1crypto, pyasn1
