...
requirements = python3,kivy==2.2.0,kivymd,plyer,pillow,google-generativeai,requests,certifi,urllib3,idna,charset-normalizer,matplotlib,python-dotenv,pg8000,scramp,openssl
